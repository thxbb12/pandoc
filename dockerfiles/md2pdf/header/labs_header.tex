...
%%% Reduce title's top margin
%\usepackage{titling}
%\setlength{\droptitle}{-1.5cm}

%%% Displays the page number and total number of pages in the footer
\usepackage{lastpage}
\usepackage{fancyhdr}
...
\usepackage{sectsty}
\subsectionfont{\sectionrule{3px}{0pt}{-1ex}{1pt}}
%\subsectionfont{\underline}

%% lstlisting
\usepackage{listings}
\definecolor{mylgray}{HTML}{f2f2f2}
%\definecolor{mylcorr}{HTML}{e6eeff}
\definecolor{mylcorr}{HTML}{fff2e6}
\definecolor{mycmt}{HTML}{339933}

%% solutions code highlight
\lstdefinestyle{solutions}{
  inputencoding=utf8,
     extendedchars=true,
     literate=%
     {é}{{\'{e}}}1
...
\lstset{basicstyle=\ttfamily,
  inputencoding=utf8,
     ...
     {Â}{{\^{A}}}1
     {Î}{{\^{I}}}1,
  backgroundcolor = \color{mylgray},
  breaklines=true,
  % frame=single,
  showstringspaces=false,
  commentstyle=\color{mycmt},
  keywordstyle=\color{blue}
}

%% comment solutions sections
\usepackage{comment}
$if(solutions)$
\specialcomment{comment}{\begingroup\color{Plum}}{\endgroup}
%\specialcomment{examen}{\begingroup\color{Red}}{\endgroup}
%\includecomment{comment}
%\specialcomment{comment}{\begingroup}{\endgroup}
$else$
$endif$
